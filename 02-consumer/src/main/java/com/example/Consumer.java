...
//        properties.put("group.initial.rebalance.delay.ms", "3000");
        ...
        kafkaConsumer.subscribe(Arrays.asList("topic4"), new ConsumerRebalanceListener(kafkaConsumer,currentProcessedOffsets));
...
//                    System.out.println("Record Partition " + record.partition());
                    ...
                    currentProcessedOffsets.put(new TopicPartition(record.topic(),record.partition()),new OffsetAndMetadata(record.offset()+1,"no metadata"));
                });
